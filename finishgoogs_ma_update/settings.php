...
$adminGroups = [
    ['title' => 'สต็อกและสถานะเครื่อง', 'note' => 'ใช้ประจำ', 'items' => [
        ...
        ['inv_pickup_map.php', 'download', 'ผูกใบเบิก inventory กับรุ่น', 'ชุด/อะไหล่ที่เบิกผลิต → รุ่นของเรา · วันเริ่มติดตาม'],
    ]],
    ...
    ['title' => 'เครื่องมือแก้ข้อมูล', 'note' => 'ใช้เป็นครั้งคราว', 'items' => [
        ...
        ['parts_link_check.php', 'parts', 'ตรวจการจับคู่อะไหล่กับคลังช่าง', 'อะไหล่ที่อยู่ในฟอร์มแต่เบิกไม่ได้ · รหัส Stock ไม่ตรง'],
        ['unused_images.php', 'camera', 'รูปที่ไม่ได้ใช้งาน', 'หารูปที่ไม่มีข้อมูลอ้างถึง · ย้ายไปถังขยะ · กู้คืนได้'],
        ['leasing_sn_fix.php', 'switch', 'แก้ S/N ในระบบเช่า', 'กรอกผิดตอนลงทะเบียน · แก้ทะเบียนเครื่อง สัญญา และประวัติ MA พร้อมกัน'],
    ]],
    ['title' => 'ตั้งค่าระบบ', 'note' => '', 'items' => [
        ...
        ['integration.php', 'external-link', 'การเชื่อมต่อกับระบบอื่น', 'งานขาย · งานเช่า · งานซ่อม · ใบเบิก · คลังอะไหล่ — เราดึงอะไร เขียนอะไร กันข้อมูลเสียหายอย่างไร'],
    ]],
];
if (!$product) { ?>
