...
$topics = [
    ...
    'produce' => [
        ...
        'steps' => [
            ...
            'ใส่รหัสเครื่อง: กด <b>สแกนต่อเนื่อง</b> แล้วสแกนทีละเครื่อง ระบบเพิ่มแถวให้เอง · สแกนซ้ำในชุดขึ้นเตือนสีเหลือง · รหัสที่ลงทะเบียนในระบบแล้วขึ้นกรอบแดงบอกว่าเป็นเครื่องอะไร และไม่ใส่ลงรายการ · บางรุ่นระบบออกเลขให้เอง แค่กด <b>เพิ่มเครื่อง</b>',
            'ป้ายที่สแกนไม่ติด (บาร์โค้ดเส้นถี่ เช่น Adapter) กด <b>ถ่ายรูปหลายเครื่อง</b> — ถ่ายรูปเดียวได้หลายเครื่อง ระบบอ่านรหัสจากรูปให้ แตะรูปข้าง S/N เพื่อขยายดูแล้วพิมพ์แก้เองได้ก่อนกดเพิ่ม (รูปอยู่ในเครื่องอย่างเดียว ไม่ได้อัปโหลด)',
            ...
            'กด <b>บันทึกทั้งชุด</b> — หน้ายืนยันจะบอกว่าจะตัดยอดจาก<b>ใบเบิก inventory</b> ใบไหน หรือเตือนว่ารุ่นนี้ไม่มีใบเบิกค้างอยู่ (ดูหัวข้อ <b>ใบเบิกรอผลิต</b>)',
        ],
    ...
    'pickup' => [
        'title' => 'ใบเบิกรอผลิต',
        'icon'  => 'download',
        'intro' => 'ของที่เบิกจากระบบ inventory ลงมาแล้ว ต้องผลิตรุ่นไหนอีกกี่เครื่อง',
        'steps' => [
            'เปิดจาก <b>Dashboard</b> การ์ด <b>ของที่เบิกมาแล้ว รอผลิต</b> → <b>ดูทั้งหมด</b> หรือปุ่ม <b>ใบเบิกรอผลิต</b> ในหน้ารายการเครื่อง',
            'การ์ดบน Dashboard บอกยอดรวม <b>ผลิตแล้ว / เบิกมา</b> พร้อมแถบความคืบหน้า และรุ่นที่ต้องผลิต 5 อันดับแรก เรียงจากด่วนสุดก่อน',
            'ป้ายข้างชื่อรุ่นบอกว่ารุ่นนั้น<b>ขาดสต็อก</b>กี่เครื่อง (แดง = ต่ำกว่าขั้นต่ำ · เหลือง = ไม่พอส่ง PO · เทา = สต็อกครบแล้ว) บรรทัดรองบอกว่าของ<b>ค้างมากี่วัน</b>แล้ว · เปลี่ยนวิธีเรียงได้ที่เมนู <b>เรียงตาม</b> (ด่วนสุด / เบิกเก่าสุด / เหลือมากสุด)',
            'กดที่ชื่อรุ่นบนการ์ด — เห็นทีละใบเบิกว่าใครเบิก เบิกมากี่เครื่อง ผลิตไปแล้วกี่เครื่อง <b>S/N ที่ผลิตจากใบนั้น</b> และอะไหล่ที่คลังจ่ายมา',
            'ในหน้าใบเบิกรอผลิต มี 3 แท็บ: <b>รอผลิต</b> (ของมาถึงแล้ว ผลิตได้เลย) · <b>รอคลังจ่าย</b> (ขอเบิกแล้วแต่คลังยังไม่จ่าย) · <b>ผลิตครบ</b>',
            'ลงทะเบียนเครื่องผลิตใหม่ตามปกติ — ระบบตัดยอดใบเบิกของรุ่นนั้นให้เอง <b>ใบเก่าสุดก่อน</b> · หน้ายืนยันก่อนบันทึกบอกว่าจะตัดจากใบไหน',
            'ถ้าตอนลงทะเบียนไม่มีใบเบิกค้าง เครื่องจะไปอยู่แท็บ <b>ลงทะเบียนโดยไม่มีใบเบิก</b> — เลือกใบแล้วกด <b>จับคู่</b> ทีหลังได้',
            'S/N ที่เป็นการนับเข้าคลังเฉย ๆ หรือเป็นของค้างจากใบเบิกเก่า ติ๊กแล้วกด <b>ไม่ต้องนับที่เลือก</b> (ใส่เหตุผลได้) — เอากลับมานับทีหลังได้จากรายการด้านล่าง',
            'ผลิตไม่ครบใบแต่จบแล้ว (ของเสีย ยกเลิก) เปิดรายละเอียดใบแล้วกด <b>ปิดรายการ</b> พร้อมเหตุผล',
        ],
        'tips'  => [
            'ตัดยอดผิดใบ: เปิดรายละเอียดใบ กด ✕ หลัง S/N เพื่อเอาออก หรือพิมพ์/สแกน S/N ในช่อง <b>ตัดยอด</b> ของใบที่ถูก ระบบย้ายให้เอง',
            'หน้าโปรไฟล์เครื่องบอกว่าเครื่องนี้ผลิตจากใบเบิกใบไหน',
            'ระบบอ่านใบเบิกจาก inventory อย่างเดียว ไม่ไปแก้อะไรในระบบนั้น · ใบที่ยังไม่ได้ผูกรุ่นจะไม่ขึ้นในคิว (ผู้ดูแลระบบผูกได้ที่ระบบหลังบ้าน → <b>ผูกใบเบิก inventory กับรุ่น</b>)',
        ],
        'go'    => [['เปิดหน้าใบเบิกรอผลิต', $B . '/inv_pickups.php']],
    ],
    'ma' => [
        'title' => 'บันทึก MA',
        'icon'  => 'ma',
    ...
    'dashboard' => [
        ...
        'steps' => [
            ...
            'แถบสีของแต่ละรุ่น: เขียว = เครื่องใหม่ · ฟ้า = คลังพร้อมเช่า · ▼ ดำ = สต็อกขั้นต่ำ · ▼ ส้ม = ขั้นต่ำ + PO — ทุกรุ่นใช้สเกลเดียวกัน แถบยาวเท่ากันคือจำนวนเครื่องเท่ากัน (รุ่นที่ยอดเกินสเกลมีป้าย › ท้ายแถบ)',
            'ตารางรุ่นแบ่ง 3 กลุ่ม (ต่ำกว่าขั้นต่ำ → ถึงขั้นต่ำแต่ไม่พอส่ง PO → ครบแล้ว) · เมนู <b>เรียงตาม</b> ข้างแถบกรองเปลี่ยนวิธีเรียงได้ (ความเร่งด่วน · ขาดมากสุด · เครื่องใหม่น้อยสุด · ต้องมีมากสุด · ชื่อรุ่น) ระบบจำค่าที่เลือกไว้ให้',
            'การ์ด <b>ของที่เบิกมาแล้ว รอผลิต</b>: ของที่เบิกจาก inventory ลงมาแล้วรอผลิต พร้อมแถบ <b>ผลิตแล้ว/เบิกมา</b> — กดที่รุ่นเพื่อดูรายละเอียดใบเบิก (ดูหัวข้อ <b>ใบเบิกรอผลิต</b>)',
...
$shots = [
    ...
    'pickup'    => [0 => ['pickup-card', 'การ์ด "ของที่เบิกมาแล้ว รอผลิต" บน Dashboard'],
                    3 => ['pickup-pop', 'กดที่ชื่อรุ่น — เห็นใบเบิก S/N ที่ผลิตแล้ว และอะไหล่ที่คลังจ่าย'],
                    4 => ['pickup-queue', 'หน้าใบเบิกรอผลิต — แท็บรอผลิต / รอคลังจ่าย / ผลิตครบ']],
