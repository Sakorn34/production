...
<form method="post" id="bulk-form">
  ...
  <div class="form-actions bulk-save-bar" style="margin-top:16px; position:sticky; bottom:0; background:var(--surface,#fff); padding:12px 0; border-top:1px solid var(--border)">
