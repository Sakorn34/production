<?php
/**
 * includes/dash_low_stock.php — รายการอะไหล่ใกล้หมดบน Dashboard
 *
...
/**
 * แสดงรายการอะไหล่ใกล้หมดแบบการ์ดแยกชิ้น
 *
...
{
    if (!$rows) {
        echo '<p class="muted dash-low-stock-empty">ไม่มีรายการใกล้หมด — สต็อกทุกตัวเพียงพอ</p>';
        return;
    }
