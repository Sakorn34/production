...
function status_palette(): array
{
    return [
        ...
        // เครื่องที่นับสต็อกแล้วไม่เจอ และไม่มีหลักฐานว่าขาย/เช่า/สำรอง/เสื่อมสภาพ/สูญหาย — รอคนตามหา
        'unknown' => ['th' => 'ไม่มีสถานะ',   'chip' => 'ไม่มีสถานะ', 'bg' => '#f3e8ff', 'fg' => '#6b21a8', 'bar' => '#d8b4fe'],
    ];
}
