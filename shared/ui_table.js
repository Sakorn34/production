...
(function () {
  ...
  function apply() {
    ...
    for (var i = 0; i < wraps.length; i++) {
      ...
      // แถวจะหยุดพอดีใต้หัวตาราง ไม่ค้างครึ่งแถวใต้มัน (scroll-snap ใน ui_table.css)
      // ต้องวัดเอาเพราะหัวตารางไทยขึ้นสองบรรทัดได้ และผู้ใช้ปรับขนาดตัวอักษรได้
      //
      // ห้ามปัดเศษทิ้ง: ความสูงจริงมีทศนิยม (เช่น 63.44px) ปัดลงแล้วแถวจะหยุดสูงกว่า
      // ขอบล่างหัวตารางเศษหนึ่ง ขอบบนของแถวโผล่พ้นมาเป็นเส้นผมบาง ๆ — คืออาการ
      // "หัวตารางปิดไม่มิด" ที่เห็นกัน · ปัดขึ้นก็ไม่ช่วย เพราะแถวชิดกัน พอดัน
      // แถวถัดไปให้ต่ำลง ท้ายแถวก่อนหน้าก็โผล่ออกมาแทนเท่ากันเป๊ะ · ต้องตรงพอดี
